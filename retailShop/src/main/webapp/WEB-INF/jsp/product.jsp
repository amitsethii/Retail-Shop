        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" method="post">
                    <button type="button" class="btn btn-warning">${result}</button>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            <div class="card" style="width=" 100%" height="300">
                                <div class="card-body">
                                    <h5 class="card-title">${retail.user}   <i style="color:rgb(92, 89, 87);"> Rs.  ${retail.price}  </i> </h5> 
                                    <p class="card-text">${retail.desc}</p>
                                </div>
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item"> <a href="/add-towish?id=${retail.id}" class="btn btn-primary">Add to Wishlist </a>
                                    </li>
                                    </li>
                                    <li class="list-group-item"> <a href="/add-tocart?id=${retail.id}" class="btn btn-success">Add to Cart </a>
